...
namespace Pulumi.Libp2p
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Libp2p.version.txt");
    ...
    internal sealed class Libp2pResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Libp2pResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
